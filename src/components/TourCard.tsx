      ...
      >
        ...
        <div className="md:w-1/2 p-6 sm:p-8 flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-[#081A33] group-hover:text-[#1E7B9E] transition-colors mb-3 leading-snug">
          ...
          <div className="space-y-4 pt-4 border-t border-slate-100">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-slate-50 border border-slate-100 text-xs text-slate-700 font-medium">
                <Calendar className="w-4 h-4 text-[#1E7B9E]" />
                <div>
            ...
            <div className="flex items-center justify-between gap-3 pt-2">
              ...
              <button
                ...
                className="text-xs font-semibold text-slate-600 hover:text-[#1E7B9E] transition-colors uppercase tracking-wider"
              >
    ...
    >
      ...
      <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between">
        <div>
          ...
          {/* Tour Title */}
          <h3 className="text-xl font-bold text-[#081A33] group-hover:text-[#1E7B9E] transition-colors duration-200 mb-2 leading-snug">
            <Link to="/tours/$slug" params={{ slug: tour.slug }}>
              {tl(tour.name)}
            </Link>
          </h3>
        ...
        <div className="space-y-4 pt-4 border-t border-slate-100">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <Link
              to="/tours/$slug"
              params={{ slug: tour.slug }}
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#1E7B9E] text-white text-xs font-semibold hover:bg-[#156380] transition-colors shadow-sm"
            >
