...
const splitPoint = fileContent.indexOf('export const tours: Tour[] = [');
if (splitPoint !== -1) {
  const topPart = fileContent.substring(0, splitPoint);
  fs.writeFileSync('src/data/site.ts', topPart + newTours, 'utf8');
